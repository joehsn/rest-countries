      ...
      <Head>
        <title className="capitalize">
          {data
            ...
            .map((country: Country) =>
              country.name.official ? country.name.official : "No country Found"
            )}{" "}
          - @joehsn
        </title>
      </Head>
                                ...
                                {data
                                  ...
                                  .map((c: Country) => (
                                    <Link
                                      ...
                                      className="w-[30%] px-4 py-1 text-sm bg-white rounded-md shadow-lg sm:w-auto text-very-dark-blue dark:text-white dark:bg-dark-blue-dm text-center"
                                    >
                                      {c.name.common}
                                    </Link>
                                  ))}
